...
# run commands : $env:MONGODB_URL = "mongodb+srv://axitmehta69_db_user:CnWR8E0qxXm9sQxI@cluster0.tmn0g2i.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
# to check : $env:MONGODB_URL : mongodb+srv://axitmehta69_db_user:CnWR8E0qxXm9sQxI@cluster0.tmn0g2i.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
...
DATA_TRANFORMATION_TRANSFORMED_DATA_DIR: str = "tranformed"
DATA_TRANFORMATION_TRANSFORMED_OBJECT_DIR: str = "tranformed_object"
...
MODEL_TRIANER_MOEL_CONFIG_FILE_PATH: str = os.path.join("config", "model.pkl")
