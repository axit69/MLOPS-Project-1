...
class DataValidation:
    ...
    def is_column_exists(self, df: DataFrame) -> bool:
        try:
            ...
            for column in self._schema_config["numericle_columns"]:
            ...
            if len(missing_categorical_columns)>0:
                logging.info(f"missing categorical_column : {missing_categorical_columns}")
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        try:
            ...
            if not status:
                validation_error_msg += f"Columns are in training dataframe"
            else:
            ...
            # ensure that directory for validation_report_file_path exists
            report_dir = os.path.dirname(self.data_validation_config.validation_report_file_path)
            os.makedirs(report_dir, exist_ok=True)

            # save  validated status and message to a json file
            validation_report = {"validation_status": validation_status, "message": validation_error_msg.strip()}
